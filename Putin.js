...
fetchAll(markets, getPoint)
  .then((data) => {
    ...
    if (maxProbability - minProbability <= 5) {
    ...
    } else if (maxProbability - minProbability > 5) {
      ...
      // Third headline option in case something unexpected happens
      headline = "Headline update failed";
    }

    // Insert the headline into the HTML element with id "headlinePutin"
