...
case 'TrumpCO.json':
  ...
  headlineText = `Trump ~${medianLatestPercentTrumpCO}% likely to appear on CO primary ballot`;
...
subHeadlineText = `If Trump disqualified from Presidency, then ~${medianLatestPercentSubTrumpDisqualified}% likely it's ruled unconstitutional`;
