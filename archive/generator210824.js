...
//  headlineText = `Israel-Iran: up to ${highestProbPercent3}% risk of deadly conflict in 2024`;
...
subHeadlineText = `Trump ~${medianLatestPercentSubTrumpJail}% likely to be criminally convicted in federal court in 2024`;
...
case 'TrumpNH.json':
  ...
  headlineText = `GOP ~${medianLatestPercentTrumpNH}% likely to win Senate in 2024`;
...
subHeadlineText = `GOP ~${medianLatestPercentSubTrumpNH}% likely to win House in 2024`;
